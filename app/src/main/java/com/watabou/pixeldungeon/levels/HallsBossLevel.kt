...
class HallsBossLevel : Level() {
    ...
    companion object {
        private const val ROOM_LEFT = DEFAULT_LEVEL_WIDTH / 2 - 1
        private const val ROOM_RIGHT = DEFAULT_LEVEL_WIDTH / 2 + 1
        private const val ROOM_TOP = DEFAULT_LEVEL_HEIGHT / 2 - 1
        private const val ROOM_BOTTOM = DEFAULT_LEVEL_HEIGHT / 2 + 1
