...
object Badges {
    enum class Badge(val description: String, val image: Int, val meta: Boolean = false) {
        ...
        BAG_BOUGHT_SEED_POUCH("", -1),
        BAG_BOUGHT_SCROLL_HOLDER("", -1),
        BAG_BOUGHT_WAND_HOLSTER("", -1),
        ...
        BOSS_SLAIN_1_WARRIOR("", -1),
        BOSS_SLAIN_1_MAGE("", -1),
        BOSS_SLAIN_1_ROGUE("", -1),
        BOSS_SLAIN_1_HUNTRESS("", -1),
        ...
        BOSS_SLAIN_3_GLADIATOR("", -1),
        BOSS_SLAIN_3_BERSERKER("", -1),
        BOSS_SLAIN_3_WARLOCK("", -1),
        BOSS_SLAIN_3_BATTLEMAGE("", -1),
        BOSS_SLAIN_3_FREERUNNER("", -1),
        BOSS_SLAIN_3_ASSASSIN("", -1),
        BOSS_SLAIN_3_SNIPER("", -1),
        BOSS_SLAIN_3_WARDEN("", -1),
    ...
    private fun restore(bundle: Bundle): HashSet<Badge> {
        ...
        val names = bundle.getStringArray(BADGES) ?: emptyArray()
    ...
    fun saveGlobal() {
        if (saveNeeded) {
            ...
            store(bundle, global)
            try {
                val output = Game.instance!!.openFileOutput(BADGES_FILE, android.content.Context.MODE_PRIVATE)
        ...
        if (badge != null) {
            ...
            if (badge == Badge.BOSS_SLAIN_1) {
                when (Dungeon.hero!!.heroClass) {
                    com.watabou.pixeldungeon.actors.hero.HeroClass.WARRIOR -> badge = Badge.BOSS_SLAIN_1_WARRIOR
                    com.watabou.pixeldungeon.actors.hero.HeroClass.MAGE -> badge = Badge.BOSS_SLAIN_1_MAGE
                    com.watabou.pixeldungeon.actors.hero.HeroClass.ROGUE -> badge = Badge.BOSS_SLAIN_1_ROGUE
                    com.watabou.pixeldungeon.actors.hero.HeroClass.HUNTRESS -> badge = Badge.BOSS_SLAIN_1_HUNTRESS
                }
                local.add(badge)
                ...
                when (Dungeon.hero!!.subClass) {
                    com.watabou.pixeldungeon.actors.hero.HeroSubClass.GLADIATOR -> badge = Badge.BOSS_SLAIN_3_GLADIATOR
                    com.watabou.pixeldungeon.actors.hero.HeroSubClass.BERSERKER -> badge = Badge.BOSS_SLAIN_3_BERSERKER
                    com.watabou.pixeldungeon.actors.hero.HeroSubClass.WARLOCK -> badge = Badge.BOSS_SLAIN_3_WARLOCK
                    com.watabou.pixeldungeon.actors.hero.HeroSubClass.BATTLEMAGE -> badge = Badge.BOSS_SLAIN_3_BATTLEMAGE
                    com.watabou.pixeldungeon.actors.hero.HeroSubClass.FREERUNNER -> badge = Badge.BOSS_SLAIN_3_FREERUNNER
                    com.watabou.pixeldungeon.actors.hero.HeroSubClass.ASSASSIN -> badge = Badge.BOSS_SLAIN_3_ASSASSIN
                    com.watabou.pixeldungeon.actors.hero.HeroSubClass.SNIPER -> badge = Badge.BOSS_SLAIN_3_SNIPER
                    com.watabou.pixeldungeon.actors.hero.HeroSubClass.WARDEN -> badge = Badge.BOSS_SLAIN_3_WARDEN
                    else -> return
                }
                local.add(badge)
                if (!global!!.contains(badge)) {
    ...
    fun validateMastery() {
        var badge: Badge? = null
        when (Dungeon.hero!!.heroClass) {
            com.watabou.pixeldungeon.actors.hero.HeroClass.WARRIOR -> badge = Badge.MASTERY_WARRIOR
            com.watabou.pixeldungeon.actors.hero.HeroClass.MAGE -> badge = Badge.MASTERY_MAGE
            com.watabou.pixeldungeon.actors.hero.HeroClass.ROGUE -> badge = Badge.MASTERY_ROGUE
            com.watabou.pixeldungeon.actors.hero.HeroClass.HUNTRESS -> badge = Badge.MASTERY_HUNTRESS
        }
        if (!global!!.contains(badge)) {
            global!!.add(badge)
            saveNeeded = true
    ...
    fun validateVictory() {
        ...
        displayBadge(badge)
        when (Dungeon.hero!!.heroClass) {
            com.watabou.pixeldungeon.actors.hero.HeroClass.WARRIOR -> badge = Badge.VICTORY_WARRIOR
            com.watabou.pixeldungeon.actors.hero.HeroClass.MAGE -> badge = Badge.VICTORY_MAGE
            com.watabou.pixeldungeon.actors.hero.HeroClass.ROGUE -> badge = Badge.VICTORY_ROGUE
            com.watabou.pixeldungeon.actors.hero.HeroClass.HUNTRESS -> badge = Badge.VICTORY_HUNTRESS
        }
        local.add(badge)
        if (!global!!.contains(badge)) {
            global!!.add(badge)
    ...
    fun filtered(global: Boolean): List<Badge> {
        val filtered = HashSet<Badge>(if (global) Badges.global ?: emptySet() else Badges.local)
