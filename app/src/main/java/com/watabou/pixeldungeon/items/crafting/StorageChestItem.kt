...
import com.watabou.pixeldungeon.actors.mobs.npcs.StorageChestNpc
...
class StorageChestItem : MaterialItem() {
    init {
        name = "storage chest"
        image = ItemSpriteSheet.STORAGE_CHEST
        stackable = false
        unique = true
    ...
    override fun info(): String =
        "A sturdy wooden chest that can be placed on the ground to store items. " +
        "Items stored inside will persist on this level."
    ...
    companion object {
        ...
        private val placer = object : CellSelector.Listener {
            ...
            override fun prompt(): String = "Choose a tile to place the chest"
        }
    }
}
